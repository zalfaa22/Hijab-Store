...
export default function Header() {
  ...
  const navItems = (
    <>
      <div className={`navbar-items ${isNavOpen ? 'open' : ''}`} style={{ position: 'absolute', right: "40px", top: "100px", background: "#fafafa", padding: "10px", width: "200px", }}>
  ...
  return (
    <>
      <div className="double-nav py-4 bg-transparent w-100">
        <Nav className="w-100 px-3 d-flex justify-content-between" activeKey="/">
          {/* NAVBAR 1 */}
          <Nav className="">
          ...
          <Navbar.Brand
            href="#home"
            className="logo d-none d-md-flex align-items-center "
          >
            <img src="./assets/logo.svg" alt="" className="w-100 h-100 me-3" />
            <p className="fs-3 fw-bold">zada kheir</p>
          </Navbar.Brand>

          <Nav.Item className="d-flex">
          <div className="kanan d-none d-lg-flex rounded-circle p-2 me-3">
              <img src="../assets/hero/search.svg" alt="" />
            </div>
            <div className="kanan rounded-circle p-2 me-3">
        ...
        {/* NAVBAR 2 */}
        <div className="navbar-container d-lg-none mt-3 px-4 d-flex align-items-center justify-content-between">
          ...
          <div className="logo-mobile me-4 d-md-none">
          ...
          <div className="search w-100 rounded-pill mx-auto p-2 d-flex justify-content-start">
            ...
            <input type="text" className="input-search w-100 border-0 bg-transparent" placeholder="pashmina"/>
          </div>
